                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.other_service_summary.update', ['slug' => $summary->slug]) }}" method="POST" class="form-group" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <select class="select2bs4" name="other_service" data-placeholder="Bilgilendirme İçin Sağlık Hizmeti Seçin" autocomplete="off"
                                            style="width: 100%;" required>
                                        @forelse($other_services as $service)
                                            <option value="{{ $service->id }}" @if($service->id === $summary->other_service_id) selected @endif> {{ $service->name }} </option>
                                        @empty
                                        @endforelse
                                    </select>
                                    <br>
