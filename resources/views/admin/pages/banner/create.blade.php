                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Yeni Resim Kaydı</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.banner.store') }}" method="POST" class="form-group" enctype="multipart/form-data">
                                    @csrf
                                    {{-- Profile Photo --}}
                                    <div class="col-md-2 offset-5">
                                        <div class="picture-container">
                                            <label class="">Sayfa Resmi <span>*</span></label>
                                            <div class="picture">
                                    ...
                                    <select class="form-control" name="page" data-placeholder="Resim hangi sayfaya eklenecek" autocomplete="off"
                                        ...
                                        <option value="doktorlarimiz">Doktorlarımız</option>
                                        <option value="bolumlerimiz">Bölümlerimiz</option>
                                        <option value="hizmetlerimiz">Hizmetlerimiz</option>
                                        <option value="diger-hizmetlerimiz">Diğer Hizmetlerimiz</option>
