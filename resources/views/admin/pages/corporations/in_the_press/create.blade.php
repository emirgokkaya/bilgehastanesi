                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Yeni Basın Kaydı</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.in_the_press.store') }}" method="POST" class="form-group" enctype="multipart/form-data">
                                    @csrf
                                    {{-- Profile Photo --}}
                                    ...
                                    <input class="form-control" name="title" type="text" placeholder="Lorem ipsum ..." required>
                                    <br>

                                    <label>Haber Tarih <span>*</span></label>
                                    <input class="form-control" name="history" type="date" placeholder="02/06/2020" required>
                                    <br>
