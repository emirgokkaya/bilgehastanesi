                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.service_summary.store') }}" method="POST" class="form-group" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <select class="select2bs4" name="service" data-placeholder="Bilgilendirme için Hizmet Seçin" autocomplete="off"
